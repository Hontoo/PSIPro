...
//    DEBUG_PRINT("Pattern State: "); 
//    DEBUG_PRINT_LN(ledPatternState); 

//    DEBUG_PRINT("Primary: "); DEBUG_PRINT_LN(frontPrimaryColor); 
//    DEBUG_PRINT("Color "); DEBUG_PRINT_LN(color);
//    DEBUG_PRINT("Color%100 "); DEBUG_PRINT_LN(color % 100);
//    DEBUG_PRINT("Color%20: "); DEBUG_PRINT_LN(color % 20);
//    DEBUG_PRINT("Color%12: "); DEBUG_PRINT_LN(color % 12);
